...
const Contact = () => {
  return (
    <div>
       ...
       <a href="#" className="lg:flex lg:items-center p-2  transition-all duration-100 ease-in-out border-2 border-transparent hover:border-[#e6ffe6] hover:scale-110  " id="div-hover-socials">
