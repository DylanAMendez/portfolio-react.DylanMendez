  ...
  return (
    ...
    <div className=" lg:mx-[40px] grid grid-cols-1 gap-4 sm:gap-4 place-content-around sm:h-[400px] h-[64vh] lg:h-[71vh]      md:grid-cols-2 md:align-items-[center] md:justify-items-center " id="heroContainer">
        ...
        <div className="">
            ...
            <a href="#" className=" flex " > <svg xmlns="http://www.w3.org/2000/svg" height="27" width="27" viewBox="0 0 512 512"><path fill="#4fc990" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
            <strong className="hidden lg:flex lg:ml-1 text-[#e6ffe6] "> Email </strong>
             </a>

            <a href="#" className="  flex transition-all duration-100 ease-in-out hover:border-[#e6ffe6] hover:scale-110 " > 
        ...
        <div className="text-center">
            ...
            <a className="text-center font-fontRoboto font-medium " href="#contact" id="button-information">CONTACTAR</a>
            </button>
        </div>
