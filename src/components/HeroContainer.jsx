      ...
      <div className=" mt-28 lg:mt-2 lg:ml-20  grid grid-cols-1 ">
        ...
        <div className="">
          ...
          <div className="flex text-center justify-evenly  text-[#23714D] mt-7 " >
            ...
            <a href="https://drive.google.com/file/d/1FtVPSk1qAGaA4e8lpkm_VrimP_YBuGdL/view?usp=sharing" rel="noreferrer" target="_blank" className=" flex  transition-all duration-100 ease-in-out hover:border-b-2 hover:border-[#e6ffe6] hover:scale-110" >
