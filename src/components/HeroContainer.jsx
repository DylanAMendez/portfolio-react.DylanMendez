  ...
  return (
    ...
    <div className=" lg:mx-[40px] grid grid-cols-1 gap-4 sm:gap-4 place-content-around sm:h-[400px] h-[81vh] lg:h-[71vh]      md:grid-cols-2 md:align-items-[center] md:justify-items-center " id="heroContainer">
        ...
        <div className="">
            ...
            <a href="https://docs.google.com/file/d/1QrCNez7OQtIkW3oCxwLraedqkt7mgzPoscx_r2zFkkg/view" rel="noreferrer" target="_blank" className=" flex  transition-all duration-100 ease-in-out hover:border-b-2 hover:border-[#e6ffe6] hover:scale-110" >
